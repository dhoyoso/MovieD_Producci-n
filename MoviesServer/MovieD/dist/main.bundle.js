...
var routes = [
    ...
    { path: 'home', component: __WEBPACK_IMPORTED_MODULE_2__components_home_component__["a" /* HomeComponent */] }
];
...
*/
//# sourceMappingURL=C:/Users/USER/Documents/topicostelematicap1-2-prod/MoviesServer/MovieD/src/app-routing.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__cust_ext_browser_xhr__ = __webpack_require__("../../../../../src/app/cust-ext-browser-xhr.ts");
...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_7__services_user_service__["a" /* UserService */], __WEBPACK_IMPORTED_MODULE_8__services_movie_service__["a" /* MovieService */], __WEBPACK_IMPORTED_MODULE_9__cust_ext_browser_xhr__["a" /* CustExtBrowserXhr */]],
...
//# sourceMappingURL=C:/Users/USER/Documents/topicostelematicap1-2-prod/MoviesServer/MovieD/src/app.module.js.map
...
var AppComponent = (function () {
    ...
    AppComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_6" /* Component */])({
            selector: 'app-root',
            template: __webpack_require__("../../../../../src/app/htmls/app.component.html"),
            styleUrls: []
        }), 
        __metadata('design:paramtypes', [])
    ], AppComponent);
...
//# sourceMappingURL=C:/Users/USER/Documents/topicostelematicap1-2-prod/MoviesServer/MovieD/src/app.component.js.map
...
var HomeComponent = (function () {
    function HomeComponent(userService, movieService) {
        var _this = this;
        ...
        this.movieService.getAllMovies().then(function (res) {
            _this.allMovies = res;
            _this.genres = ["Action", "Adventure", "Comedy", "Crime", "Drama", "Romance", "Horror", "Musical", "Science fiction", "Mystery"];
            _this.visibility = ["public", "private"];
            /**
    ...
    HomeComponent.prototype.search = function (searchTerm) {
        var _this = this;
        this.movieService.searchMovieByTitle(searchTerm).then(function (res) {
            _this.allMovies = res;
            console.log(_this.allMovies);
            _this.refreshContent();
        });
    };
    HomeComponent.prototype.saveMovieToDeleteAndOpenConfirmModal = function (movie) {
        this.movieToDelete = movie;
        document.getElementById("confirmModal").className = ("modal in");
    };
    HomeComponent.prototype.deleteThisMovie = function () {
        var _this = this;
        var movie = this.movieToDelete;
        this.movieService.deleteMovie(movie._id.toString()).then(function (res) {
            _this.myContent();
            document.getElementById("confirmModal").className = ("modal fade in hide");
        });
    };
    HomeComponent.prototype.searchByGenre = function (genre) {
        var _this = this;
        this.myContents = false;
        this.divHeight = "420px";
        this.movieService.getAllMoviesByGenre(genre).then(function (res) {
            _this.allMovies = res;
            _this.refreshContent();
        });
    };
    HomeComponent.prototype.changePage = function (id) {
    ...
    HomeComponent.prototype.createMovie = function (title, year, director, size, url, genre, visibility) {
        var _this = this;
        if (title != "" && year != "" && director != "" && size != "" && url != "" && genre != "" && visibility != "") {
            this.userService.getLogUserInfo().then(function (res) {
                ...
                _this.movieService.createMovie(movie).then(function (ress) {
                    console.log(ress);
                    if (ress) {
    ...
    HomeComponent.prototype.login = function (username, passw) {
        var _this = this;
    ...
    HomeComponent.prototype.logout = function () {
        ...
        document.getElementById("loginButton").addEventListener('click', (function (event) {
            _this.changeLoginModalId();
        }));
    };
    HomeComponent.prototype.loguedUser = function () {
        var _this = this;
        document.getElementById("closeLoginModal").click();
        document.getElementById("loginErrorMsg").className = "alert alert-error hide";
        document.getElementById("loginButton").textContent = "Log Out";
    ...
    HomeComponent.prototype.changeLoginModalId = function () {
        document.getElementById("loguedInModal").id = "loginModal";
        document.getElementById("loginButton").removeEventListener('click');
    };
    HomeComponent.prototype.register = function (username, passw, passw2) {
        var _this = this;
        if (passw == passw2) {
    ...
    HomeComponent.prototype.nextPage = function () {
        if (this.lastPage < this.numberOfPages) {
            var next;
            var next_1 = this.lastPage + 1;
            this.changePage(next_1.toString());
        }
    };
    HomeComponent.prototype.prevPage = function () {
        if (this.lastPage > 1) {
            var prev;
            var prev_1 = this.lastPage - 1;
            this.changePage(prev_1.toString());
        }
    };
    HomeComponent.prototype.myContent = function () {
        var _this = this;
        this.searcherFlag = false;
        this.userService.getLogUserInfo().then(function (res) {
            if (res.status.toString().indexOf("200") != -1) {
                _this.myContents = true;
                _this.divHeight = "530px";
                _this.movieService.getMyMovies(JSON.parse(res._body).username).then(function (ress) {
                    _this.allMovies = ress;
                    _this.refreshContent();
                });
            }
        });
    };
    HomeComponent.prototype.contentSharedWithMe = function () {
        var _this = this;
        this.searcherFlag = false;
        this.userService.getLogUserInfo().then(function (res) {
            if (res.status.toString().indexOf("200") != -1) {
                _this.divHeight = "420px";
                _this.myContents = false;
                _this.movieService.getMoviesSharedWithMe(JSON.parse(res._body).username).then(function (ress) {
                    _this.allMovies = ress;
                    _this.refreshContent();
                });
            }
    ...
    HomeComponent.prototype.refreshContent = function () {
        var i;
        i = 0;
    ...
    HomeComponent.prototype.shareWith = function (username, movie) {
        var _this = this;
        this.userService.searchUser(username).then(function (res) {
            if (res._body.toString().indexOf("error") == -1) {
                _this.movieService.shareMovieWith(movie._id, username).then(function (res) {
                    console.log(res);
                    if (res.toString().indexOf("hay error") == -1) {
                        ...
                        _this.searched1 = null;
                        _this.searched2 = null;
    ...
    HomeComponent.prototype.getRowsFromAllMovies = function (page) {
        this.showingMoviesRow1 = [];
        this.showingMoviesRow2 = [];
        var i;
        i = (page * 8) - 8;
    ...
    HomeComponent.prototype.getMovieToEdit = function (movie, genre) {
    ...
    HomeComponent.prototype.editMovie = function () {
        var _this = this;
        var movie = new __WEBPACK_IMPORTED_MODULE_1__models_Movie__["a" /* Movie */]();
        movie = {
            _id: this.editingid,
        ...
        console.log(movie);
        this.movieService.updateMovie(movie).then(function (res) {
            if (res.status.toString().indexOf("200") != -1) {
    ...
    HomeComponent.prototype.closeErrorModal = function () {
        document.getElementById("errorModal").className = ("modal fade in hide errorModal");
    };
    HomeComponent.prototype.closeSuccessModal = function () {
        document.getElementById("successModal").className = ("modal fade in hide errorModal");
    };
    HomeComponent.prototype.closeConfirmModal = function () {
        document.getElementById("confirmModal").className = ("modal fade in hide errorModal");
    };
    HomeComponent.prototype.closeconfirmAccountModal = function () {
        document.getElementById("confirmAccountModal").className = ("modal fade in hide errorModal");
    };
    HomeComponent.prototype.openConfirmDeleteAcc = function () {
        document.getElementById("confirmAccountModal").className = ("modal  in ");
    };
    HomeComponent.prototype.deleteThisAccount = function () {
        var _this = this;
        this.userService.getLogUserInfo().then(function (res) {
            _this.logout();
            var username = JSON.parse(res._body).username;
            _this.userService.deleteUser(username).then(function (ress) {
                console.log(ress);
                _this.closeconfirmAccountModal();
            });
        });
    };
    HomeComponent.prototype.changeUsername = function (username) {
        var _this = this;
        this.userService.searchUser(username).then(function (res) {
            if (res._body.toString().indexOf("_id") == -1) {
                _this.userService.getLogUserInfo()
                    .then(function (res) {
                    _this.userService.updateUsername(JSON.parse(res._body)._id, username).then(function (res) { });
    ...
    HomeComponent.prototype.changePassword = function (passw1, passw2) {
        var _this = this;
        if (passw1 == passw2) {
    ...
    ], HomeComponent.prototype, "editingid", void 0);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["w" /* Input */])(), 
        __metadata('design:type', String)
    ], HomeComponent.prototype, "editingtitle", void 0);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["w" /* Input */])(), 
        __metadata('design:type', String)
    ], HomeComponent.prototype, "editingyear", void 0);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["w" /* Input */])(), 
        __metadata('design:type', String)
    ], HomeComponent.prototype, "editingdirector", void 0);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["w" /* Input */])(), 
        __metadata('design:type', String)
    ], HomeComponent.prototype, "editingsize", void 0);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["w" /* Input */])(), 
        __metadata('design:type', String)
    ], HomeComponent.prototype, "editinggenre", void 0);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["w" /* Input */])(), 
        __metadata('design:type', String)
    ], HomeComponent.prototype, "editingvisibility", void 0);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["w" /* Input */])(), 
        __metadata('design:type', String)
    ], HomeComponent.prototype, "editingowner", void 0);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["w" /* Input */])(), 
        __metadata('design:type', Array)
    ], HomeComponent.prototype, "editingshared", void 0);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["w" /* Input */])(), 
        __metadata('design:type', String)
    ], HomeComponent.prototype, "editingurl", void 0);
    HomeComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_6" /* Component */])({
            selector: 'home',
            template: __webpack_require__("../../../../../src/app/htmls/home.component.html"),
            styles: [__webpack_require__("../../../../../src/app/css/home.component.css"), __webpack_require__("../../../../../src/app/css/homeStyle.component.css"), __webpack_require__("../../../../../src/app/css/pagination.css"), __webpack_require__("../../../../../src/app/css/bootstrap.min.css"), __webpack_require__("../../../../../src/app/css/dropdownmenu.css")],
            providers: [__WEBPACK_IMPORTED_MODULE_2__services_user_service__["a" /* UserService */], __WEBPACK_IMPORTED_MODULE_3__services_movie_service__["a" /* MovieService */]]
        }), 
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__services_user_service__["a" /* UserService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__services_user_service__["a" /* UserService */]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__services_movie_service__["a" /* MovieService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3__services_movie_service__["a" /* MovieService */]) === 'function' && _b) || Object])
    ], HomeComponent);
    return HomeComponent;
    var _a, _b;
}());
//# sourceMappingURL=C:/Users/USER/Documents/topicostelematicap1-2-prod/MoviesServer/MovieD/src/home.component.js.map
...
/***/ "../../../../../src/app/css/home.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/css/homeStyle.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\r\n\r\na {\r\n\r\n  border: 0; outline: 0;\r\n}\r\n\r\n.pagination {\r\n  text-align: center;\r\n  margin: 20px\r\n}\r\n.pagination a, .pagination strong {\r\n  background: #111111;\r\n  display: inline-block;\r\n  margin-right: 3px;\r\n  padding: 4px 12px;\r\n  text-decoration: none;\r\n  line-height: 1.5em;\r\n  border-radius: 3px;\r\n}\r\n.pagination a:hover {\r\n  background-color: #BEBEBE;\r\n  color: #fff;\r\n}\r\n.pagination a:active {\r\n  background: rgba(190, 190, 190, 0.75);\r\n}\r\n.pagination .strong {\r\n  color: #fff;\r\n  background-color: #3e4249;\r\n  font-family: Georgia,\"Times New Roman\",serif;\r\n  font-size: 16px;\r\n  font-weight: bold;\r\n  line-height: 22px;\r\n  margin: 0;\r\n}\r\n\r\n.innerpagination{\r\n  display: table;\r\n  margin: 0 auto;\r\n}\r\n\r\n#searchshare {\r\n  float: right;\r\n  margin-top: 9px;\r\n  width: 200px;\r\n  margin-right: 10px;\r\n}\r\n\r\n.searchshare {\r\n  padding: 5px 0;\r\n  width: 230px;\r\n  height: 30px;\r\n  position: relative;\r\n  left: 0px;\r\n  float: left;\r\n  line-height: 22px;\r\n  margin-right: 0px;\r\n}\r\n\r\n.searchshare .inputshare {\r\n  position: absolute;\r\n  width: 0px;\r\n  float: Left;\r\n  margin-left: 200px;\r\n  transition: all 0.7s ease-in-out;\r\n  height: 30px;\r\n  line-height: 18px;\r\n  padding: 0 2px 0 2px;\r\n  border-radius:1px;\r\n}\r\nfooter {\r\n  position: fixed;\r\n  height: 80px;\r\n  bottom: 0;\r\n  width: 100%;\r\n}\r\n.searchshare:hover .inputshare, .searchshare .inputshare:focus {\r\n  width: 200px;\r\n  margin-left: 0px;\r\n  margin-right: 20px;\r\n}\r\n\r\n.btnshare {\r\n  height: 30px;\r\n  position: absolute;\r\n  right: 0;\r\n  top: 5px;\r\n  border-radius:1px;\r\n  margin-right: 10px;\r\n}\r\n\r\n", ""]);
...
//# sourceMappingURL=C:/Users/USER/Documents/topicostelematicap1-2-prod/MoviesServer/MovieD/src/cust-ext-browser-xhr.js.map
...
/***/ "../../../../../src/app/fonts/glyphicons-halflings-regular.woff2":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/htmls/app.component.html":
/***/ (function(module, exports) {
...
/***/ "../../../../../src/app/htmls/home.component.html":
/***/ (function(module, exports) {
...
//# sourceMappingURL=C:/Users/USER/Documents/topicostelematicap1-2-prod/MoviesServer/MovieD/src/Movie.js.map
...
var MovieService = (function () {
    ...
    MovieService.prototype.deleteMovie = function (_id) {
        var url = this.movieUrl + "deleteMovie";
    ...
    MovieService.prototype.searchMovieByTitle = function (searchTerm) {
        var url = this.movieUrl + "searchMovie";
        return this.http.post(url, JSON.stringify({ searchTerm: searchTerm }), { headers: this.headers })
            .toPromise()
            .then(function (res) { return res.json(); })
            .catch(this.handleError);
    };
    MovieService.prototype.getAllMoviesByGenre = function (searchTerm) {
        return this.http.post(this.movieUrl + "movieGenre", JSON.stringify({ searchTerm: searchTerm }), { headers: this.headers })
            .toPromise()
            .then(function (res) { return res.json(); })
            .catch(this.handleError);
    };
    MovieService.prototype.getMyMovies = function (username) {
        var url = this.movieUrl + "myContent";
        return this.http.post(url, JSON.stringify({ username: username }), { headers: this.headers, withCredentials: true })
            .toPromise()
            .then(function (res) { return res.json(); })
            .catch(this.handleError);
    };
    MovieService.prototype.getMoviesSharedWithMe = function (username) {
        var url = this.movieUrl + "sharedWithMe";
        return this.http.post(url, JSON.stringify({ username: username }), { headers: this.headers, withCredentials: true })
            .toPromise()
            .then(function (res) { return res.json(); })
            .catch(this.handleError);
    };
    MovieService.prototype.shareMovieWith = function (_id, username) {
...
//# sourceMappingURL=C:/Users/USER/Documents/topicostelematicap1-2-prod/MoviesServer/MovieD/src/movie.service.js.map
...
var UserService = (function () {
    function UserService(http) {
        this.http = http;
        this.headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* Headers */]({ "Content-Type": "application/json" });
        this.passheaders = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* Headers */]({ "Content-Type": "application/x-www-form-urlencoded" });
        this.userUrl = '';
    }
    ...
    UserService.prototype.updateUsername = function (id, username) {
...
//# sourceMappingURL=C:/Users/USER/Documents/topicostelematicap1-2-prod/MoviesServer/MovieD/src/user.service.js.map
...
//# sourceMappingURL=C:/Users/USER/Documents/topicostelematicap1-2-prod/MoviesServer/MovieD/src/environment.js.map
...
//# sourceMappingURL=C:/Users/USER/Documents/topicostelematicap1-2-prod/MoviesServer/MovieD/src/main.js.map
